...
<?php if ( have_posts() ): ?>
	<?php while( have_posts() ): ?>
		...
		<section class="container">
			...
			<?php $pratos1 = get_field('pratos_1'); ?>

			<?php if ( isset($pratos1) ): ?>
			<div class="menu-item grid-8">
				<h2><?php the_field('especialidade_prato_1'); ?></h2>
				<ul>
			...
			<?php $pratos2 = get_field('pratos_2'); ?>

			<?php if ( isset($pratos2) ): ?>
				<div class="menu-item grid-8">
					<h2><?php the_field('especialidade_prato_2'); ?></h2>
					<ul>
	...
	<?php endwhile; ?>
<?php else: ?>
	<p><?php esc_html_e( 'Desculpe, nenhum post corresponde a seu critério' ); ?></p>
<?php endif; ?>
